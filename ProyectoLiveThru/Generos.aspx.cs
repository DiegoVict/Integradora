...
namespace ProyectoLiveThru
{
    public partial class Generos : System.Web.UI.Page
    {
        ...
        public void getAllGeneros()
        {
            ...
            Negocio.Services.Genero generoservices = new Negocio.Services.Genero();

            lGenero = generoservices.GetAllObjetc();
            ...
            foreach (Negocio.BO.Genero item in lGenero)
            {
                ...
                l1.Text = "<div class=\"col-xs-6 col-sm-4 col-md-4 col-lg-3\">" +
                          "<div class=\"item\">" +
                          "<div class=\"pos-rlt\">" +
                          "<a href=\"Artistas.aspx?Id=" + item.id + "\"><img src=\"" + item.imagen + " \" alt=\"\" class=\"r r-2x img-full\"></a>" +
                          "</div>" +
                          "<div class=\"padder-v\">" +
                          //"<a href=\"perfilArtista.aspx?Id=" + item.id + "\" class=\"text-ellipsis\">" + item.nombre + "</a>";
                          "<a href=\"#\" class=\"text-ellipsis text-xs text-muted\">20 Artistas</a>"+
                          "<a href=\"#\" class=\"text-ellipsis text-xs text-muted\">103 Canciones</a>"+
                          "</div>" +
                          "</div>" +
                          "</div>";
        ...
        public void getAllArtistas()
        {
            ...
            foreach (Negocio.BO.UsuarioArtistaOrganizador item in loUsuarioArtistaOrganizador)
            {
                ...
                l2.Text = "<div class=\"item\">";
                l3.Text = "<div class=\"pos-rlt\">";
                l4.Text = "<a href=\"perfilArtista.aspx?Id="+item.id+"\"><img src=\"" + item.imagen + " \" alt=\"\" class=\"r r-2x img-full\"></a>";
                l5.Text = "</div>";
