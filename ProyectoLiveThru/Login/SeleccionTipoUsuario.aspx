<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeleccionTipoUsuario.aspx.cs" Inherits="ProyectoLiveThru.Login.SeleccionTipoUsuario" %>
...
<head runat="server">
    <meta charset="utf-8">
    <link href="css/FlatTables/StyleFlatTable.css" rel="stylesheet" />
...
<div class="row-fluid">
            ...
            <div class="span3 tiny">
                ...
                <img src="login8.jpg" width="100%" height="100%" />
